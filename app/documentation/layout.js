...
// Shared shell for /documentation — same pattern as app/users/layout.js,
// admin-only. Storage for planning docs inside the app itself; see
// PORTALS_AND_ROLES_PLAN.md.
      ...
      <header style={{ position: 'sticky', top: 0, zIndex: 20, background: 'var(--header-bg)', borderBottom: '1px solid var(--line)' }}>
        <div style={{ padding: '18px 20px 14px', display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
          <div>
            ...
            <h1 style={{ fontSize: 22, fontWeight: 700, letterSpacing: '0.02em', textTransform: 'uppercase', margin: 0, color: 'var(--header-text)' }}>Documentation</h1>
          </div>
